...
SRC_URI = "${GLIBC_GIT_URI};branch=${SRCBRANCH};name=glibc \
           ...
           file://0001-AARCH64-Rewrite-elf_machine_load_address-using-_DYNA.patch \
           file://0001-glibc2.23-Backport-of-http-patchwork.ozlabs.org-patc.patch \
           file://0001-glibc-Ported-localedef-no-hard-links-option-from-2.3.patch \
           file://0001-Verbatim-backports-of.patch \
           file://0001-Backport-of-deprecate-libcrypt-patch-from-2.27.patch \
"
...
TARGET_CPPFLAGS += "-Wno-missing-attributes \
 -Wno-error=array-bounds -Wno-error=stringop-truncation -Wno-error=multistatement-macros \
 -Wno-error=dangling-else -Wno-error=int-in-bool-context -Wno-error=switch-unreachable \
 -Wno-error=format-overflow= -Wno-error=nonnull -Wno-error=format-truncation= \
 -Wno-error=restrict \
"
